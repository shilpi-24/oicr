...
const Register = (props) => {
 ...
 // const [password, setPassword] = useState("");
  ...
  //state
 const [password, setStatename] = React.useState({
    password: ""
...
const [form, setForm] = useState({
  ...
  const handleRegister = (e) => {
    ...
    if (checkBtn.current.context._errors.length === 0) {
      AuthService.register(username, email, password.password, roles, statename, contactno).then(
        (response) => {
    ...
    <div className="col-md-12">
      <div className="card card-container">
        ...
        Password not matched
			   ...
			   <select className="form-control" value={statename} onChange={onChangeStatename}  {...error.country} >
